...
(function () {
    ...
    angular
        .module('angle', [
            ...
            APISERVICEBASEURI: 'http://localhost:59626/',
            //APISERVICEBASEURI: 'http://sistemas.globalsys.com.br:8021/',
            //APISERVICEBASEURI: 'http://sistemas.globalsys.com.br:8019/', /*Homologacao*/
        CLIENTID: 'ngAuthApp'
    });
})();
...
(function () {
    ...
    angular
        ...
        .constant('APP_REQUIRES', {
            ...
            scripts: {
                'auth': ['globalsys/services/authService.js'],
                'login': ['globalsys/services/authService.js', 'globalsys/controllers/loginController.js'],
                'usuario': ['globalsys/services/seguranca/usuarioService.js', 'globalsys/controllers/seguranca/usuarioController.js'],
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $stateProvider
            .state('app', {
                ...
                resolve: helper.resolveFor('modernizr', 'icons', 'auth')
            })
...
(function () {
    ...
    function settingsRun($rootScope, $localStorage) {
        ...
        $rootScope.app = {
            ...
            logoGlobalsys: '../app/img/globalsys.png',
            layout: {
                isFixed: true,
                isCollapsed: false,
                isBoxed: false,
...
(function () {
    ...
    SidebarLoader.$inject = ['$http','AUTHSETTINGS'];
    function SidebarLoader($http, AUTHSETTINGS) {
        ...
        function getMenu(onReady, onError) {
            ...
            */
            onError = onError || function () {
                removeLoader();
                //sweetAlert("Atenção", 'Falha ao carregar o menu', "error");
            };
            addLoader();
            /*$http
              .get(menuURL)
            ...
            $http.get(serviceBase + 'api/Menu?codigo=' + parseInt(moduloID))
                .success(onReady)
                .error(onError);
        }
    }
